...
public class HttpRestClient {
	...
	private void executePost() {
		...
		try {
			...
			org.apache.http.client.HttpClient aClient = createHttpClient(httpParams);
	...
	private org.apache.http.client.HttpClient createHttpClient(BasicHttpParams httpParams) {
		EastAppsHttpClient client = new EastAppsHttpClient(getContext());
		ClientConnectionManager clientConnMgr = client.createClientConnectionManager();
		
		org.apache.http.client.HttpClient aClient = new DefaultHttpClient(clientConnMgr, httpParams);
		return aClient;
	}
